<%@ Page ValidateRequest="false" Language="C#" MasterPageFile="~/BVAdmin/BVAdminNav.master" AutoEventWireup="True" Inherits="MerchantTribeStore.BVAdmin_Catalog_Products_Edit" Title="Untitled Page" CodeBehind="Products_Edit.aspx.cs" %>
        ...
        <table class="formtable" cellspacing="0" cellpadding="3" border="0">
            <tr>
                <td class="formfield" colspan="2">
                    ...
                    <asp:ImageButton ID="update1" CssClass="autoactivatebutton" runat="server" ImageUrl="../images/buttons/update.png"
                        OnClick="update1_Click" />
                    <asp:ImageButton ID="btnSave2" TabIndex="9005" runat="server" ImageUrl="../images/buttons/SaveChanges.png"
                        OnClick="btnSave2_Click"></asp:ImageButton>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="formfield" valign="top" align="left">
                    ...
                    <asp:RequiredFieldValidator ID="valSkuRequired" runat="server" ControlToValidate="SkuField"
                        ErrorMessage="Sku is Required" Text="*"></asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="valSkuLength" runat="server" ControlToValidate="SkuField"
                        ErrorMessage="Sku can not be more than 50 characters long." OnServerValidate="valSkuLength_ServerValidate">*</asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td class="formlabel" align="right" valign="top">
            ...
            <tr>
                ...
                <td class="formfield" align="left">
                    ...
                    <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="CostField"
                        CssClass="errormessage" ErrorMessage="Cost must be a currency value">*</asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td class="formlabel" align="right" valign="top">
                ...
                <td class="formfield" align="left">
                    ...
                    Text:
                    <asp:TextBox ID="PriceOverrideTextBox" runat="server" Columns="10" TabIndex="2300"></asp:TextBox>&nbsp;
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="MetaTitleField" runat="server" Columns="40" Rows="1" Width="225px"
                        TabIndex="3200"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="formLabel" align="right" valign="top">
                ...
                <td>
                    <asp:TextBox ID="MetaDescriptionField" runat="server" TextMode="multiLine" Columns="40"
                        Rows="3" Width="225" TabIndex="3300"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="formLabel" align="right" valign="top">
                ...
                <td>
                    <asp:TextBox ID="MetaKeywordsField" runat="server" TextMode="multiLine" Columns="40"
                        Rows="3" Width="225px" TabIndex="3400"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td class="formfield">
                    <asp:CheckBox Checked="false" ID="TaxExemptField" TabIndex="4100" runat="server">
                    </asp:CheckBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="formfield">
                    ...
                    <asp:CustomValidator ID="CustomValidator4" runat="server" ControlToValidate="WeightField"
                        Display="Dynamic" ErrorMessage="Weight must be a numeric value.">*</asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td class="formLabel" align="right" valign="top">
                ...
                <td class="formfield">
                    ...
                    L x
                    <asp:TextBox ID="WidthField" runat="server" Columns="5" Rows="1" TabIndex="5200"></asp:TextBox>
                    ...
                    W x
                    <asp:TextBox ID="HeightField" runat="server" Columns="5" Rows="1" TabIndex="5300"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="formfield">
                    ...
                    <asp:CustomValidator ID="CustomValidator8" runat="server" ControlToValidate="ExtraShipFeeField"
                        Display="Dynamic" ErrorMessage="Extra Ship Fee must be a numeric value.">*</asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td class="formLabel" align="right" valign="top">
            ...
            <tr style="display: none;">
                ...
                <td class="formfield">
                    <asp:CheckBox ID="chkGiftWrapAllowed" runat="server" />
                </td>
            </tr>
            <tr style="display: none;">
                <td class="formlabel">
                ...
                <td class="formfield">
                    <asp:TextBox ID="txtGiftWrapCharge" runat="server" Columns="5" Rows="1" TabIndex="6050"
                    ...
                    <asp:CustomValidator ID="BVCustomValidator1" runat="server" ControlToValidate="txtGiftWrapCharge"
                        CssClass="errormessage" ErrorMessage="Gift Wrap Charge must be a currency value">*</asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="chkAllowReviews" runat="Server"></asp:CheckBox>
                </td>
            </tr>
            <tr>
                <td class="formlabel">
                ...
                <td class="formfield">
                    /<asp:TextBox ID="RewriteUrlField" ClientIDMode="Static" runat="server" Columns="30"
                        Width="180px" TabIndex="6000"></asp:TextBox>
                    <br />
            ...
            <tr>
                ...
                <td class="formfield">
                    <asp:TextBox ID="MinimumQtyField" runat="server" Columns="5" Rows="1" TabIndex="6050"
                        Text="0"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="MinimumQtyField"
                        Display="Dynamic" ErrorMessage="Minimum Quantity is required.">*</asp:RequiredFieldValidator><asp:RegularExpressionValidator
                            ...
                            Display="Dynamic" ErrorMessage="Minimum Quantity must be numeric." ValidationExpression="[0-9]{1,6}">*</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td class="formlabel">
            ...
            <tr>
                <td class="formfield" colspan="2">
                    ...
                    <asp:ImageButton ID="update2" runat="server" ImageUrl="../images/buttons/update.png"
                        TabIndex="6400" OnClick="update2_Click" />
                    &nbsp;<asp:ImageButton ID="btnSaveChanges" TabIndex="6500" runat="server" ImageUrl="../images/buttons/SaveChanges.png"
                        OnClick="btnSaveChanges_Click"></asp:ImageButton>
                </td>
            </tr>
        </table>
    </asp:Panel>
