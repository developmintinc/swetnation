            ...
            if (c != null)
            {
                ...
                if ((this.iconupload.HasFile))
                {
                    ...
                    if (MerchantTribe.Commerce.Storage.DiskStorage.ValidateImageType(ext))
                    {
                        ...
                        if ((MerchantTribe.Commerce.Storage.DiskStorage.UploadCategoryIcon(MTApp.CurrentStore.Id, c.Bvin, this.iconupload)))
                        {
                ...
                if ((this.bannerupload.HasFile))
                {
                    ...
                    {
                        fileName = MerchantTribe.Web.Text.CleanFileName(fileName);
                        if ((MerchantTribe.Commerce.Storage.DiskStorage.UploadCategoryBanner(MTApp.CurrentStore.Id, c.Bvin, this.bannerupload)))
                        {
