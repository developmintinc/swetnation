    ...
    partial class BVAdmin_Catalog_Products_Edit : BaseProductAdminPage
    {
        ...
        private bool UploadImage(Product p)
        {
            ...
            if ((this.imgupload.HasFile))
            {
                ...
                if (MerchantTribe.Commerce.Storage.DiskStorage.ValidateImageType(ext))
                {
                    ...
                    if ((MerchantTribe.Commerce.Storage.DiskStorage.UploadProductImage(MTApp.CurrentStore.Id, p.Bvin, this.imgupload)))
                    {
        ...
        */
        ...
        private void UploadImage(Product p)
        {
            ...
            MTApp.CatalogServices.ProductsUpdateWithSearchRebuild(p);
        }
