...
namespace MerchantTribe.Commerce.Membership
{
    public class CustomerPointsManager
    {
        ...
        {
            bool result = _provider.CapturePoints(userId, _storeId, points) == 1;
        ...
        {
            bool result = _provider.DecreasePoints(userId, _storeId, points) == 1;
        ...
        {
            bool result = _provider.IssuePoints(userId, _storeId, points) == 1;
