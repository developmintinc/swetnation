...
namespace SwetNation.Web.models
{
    ...
    {
        public MerchantTribe.Commerce.Catalog.Product Item { get; set; }
        ...
        public SingleProductViewModel(MerchantTribe.Commerce.Catalog.Product p, MerchantTribeApplication mtapp)
        {
